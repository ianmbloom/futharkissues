...
CUdeviceptr futhark_values_raw_i64_2d(struct futhark_context *ctx,
                                      struct futhark_i64_2d *arr);
...
// Entry points
int futhark_entry_searchUvTreeImage(struct futhark_context *ctx,
                                    struct futhark_f32_2d **out0,
                                    struct futhark_i64_2d **out1, const
                                    struct futhark_f32_3d *in0, const
                                    struct futhark_f32_2d *in1);
int futhark_entry_searchUvTreeImageCollate(struct futhark_context *ctx,
                                           struct futhark_f32_1d **out0, const
                                           struct futhark_f32_3d *in0, const
                                           struct futhark_f32_2d *in1);
int futhark_entry_searchUvTreeXYPresence(struct futhark_context *ctx,
                                         struct futhark_i64_2d **out0, const
                                         float in0, const
                                         struct futhark_f32_3d *in1, const
                                         struct futhark_f32_2d *in2);
int futhark_entry_testNodeBox(struct futhark_context *ctx,
                              struct futhark_i64_2d **out0, const int64_t in0,
                              const int64_t in1);
int futhark_entry_testTreeBox(struct futhark_context *ctx,
                              struct futhark_i64_2d **out0, const int64_t in0,
                              const int64_t in1);
int futhark_entry_verifyRectFrame(struct futhark_context *ctx,
                                  struct futhark_i64_3d **out0,
                                  struct futhark_i64_3d **out1, const
                                  int64_t in0, const int64_t in1);
int futhark_entry_verifyUvGradientFrame(struct futhark_context *ctx,
                                        struct futhark_f32_3d **out0,
                                        struct futhark_f32_3d **out1, const
                                        int64_t in0, const int64_t in1);
int futhark_entry_verifyUvImageOut(struct futhark_context *ctx,
                                   struct futhark_f32_3d **out0,
                                   struct futhark_f32_3d **out1, const
                                   struct futhark_f32_3d *in0);
int futhark_entry_verifyYxUvSearch(struct futhark_context *ctx,
